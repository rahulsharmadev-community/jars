...
extension WidgetExtensions on Widget {
  ...
  Widget padding([EdgeInsetsGeometry? padding]) =>
      padding.ifNotNull(def: this, callback: (o) => Padding(padding: o, child: this));

  Widget paddingAll([double? padding]) => this.padding(padding != null ? EdgeInsets.all(padding) : null);
  ...
  Padding paddingLTRB([double left = 0.0, double top = 0.0, double right = 0.0, double bottom = 0.0]) {
