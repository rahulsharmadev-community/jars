...
enum Platform {
  ...
  void executeFor({
    ...
    if (Platform.isMobileorTablet && mobile != null) return mobile.call();
    ...
    if (Platform.isDesktop && desktop != null) return desktop.call();
    if (Platform.isWeb && web != null) return web.call();
