...
class RegPatterns {
  ...
  /// Name regex
  static name([bool allowSpace = false]) => RegPatterns._(
  ...
  /// ISBN 10 & 13 regex
  static const isbn =
      RegPatterns._(pattern: r'(ISBN(\-1[03])?[:]?[ ]?)?(([0-9Xx][- ]?){13}|([0-9Xx][- ]?){10})');
  ...
  /// Postal Code
  static postalCode({int maxLength = 6, bool allowAlphabets = false}) => RegPatterns._(
