...
enum DateTimeLang {
  ...
  hi(
    model: DateTimeLangModel(
      ...
      weekdays: DateTimeLangMetaData(NAME: "सप्ताह", LIST: [
        "रविवार",
        "सोमवार",
        "मंगलवार",
        "बुधवार",
      ...
      shortweekdays: DateTimeLangMetaData(
          NAME: "सप्ताह",
  ...
  en(
    ...
    shortmonths: DateTimeLangMetaData(NAME: "Mo", LIST: [
      "Jan",
      "Feb",
      "Mar",
      "Apr",
    ...
    weekdays: DateTimeLangMetaData(NAME: "Weeks", LIST: [
      "Sunday",
      "Monday",
      "Tuesday",
      "Wednesday",
